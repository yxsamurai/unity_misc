...
public class MaliShaderReport : EditorWindow
{
    static class Content
    {
        ...
        public static readonly GUIContent targetGPUContent = new GUIContent("Target GPU", "GPU to use");
    ...
    // Target GPUs
    private string[] m_TargetGPUs = new string[]
    {
        "Mali-G77",
        "Mali-G610",
        "Mali-G57",
    ...
    [MenuItem("Tools/Mali Offline Compiler")]
    static void Init()
    {
    ...
    void OnGUI()
    {
        ...
        // Select Target GPU
        EditorGUILayout.BeginHorizontal();
        m_SelectedGPUIdx = EditorGUILayout.Popup(Content.targetGPUContent, m_SelectedGPUIdx, m_TargetGPUs);
        EditorGUILayout.EndHorizontal();
    ...
    bool Report(string path, ShaderType target, out string report)
    {
        ...
        try
        {
            ...
            compiler.StartInfo.Arguments = "-c " + m_TargetGPUs[m_SelectedGPUIdx] + " ";
